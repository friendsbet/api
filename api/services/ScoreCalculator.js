...
module.exports = {
  ...
  // // computeUserFromBet
  // // 
  // // @description :: Compute a user score attribute from a bet
  // // @param       :: betId (required): the bet concerned
  // //                 cb (required): the function called when it's done or an
  // //                 error occured
  // computeUserFromBet: function (betId, cb) {
  //   // Check the params
  //   checkParams([
  //     {
  //       value: betId,
  ...
  //       var userId = (_.pluck(instance, 'user')).id;

  //       this.computeUser(userId, cb);
  //   });
  // },
  ...
  // // computeGroupsFromBet
  // // 
  // // @description :: Compute a list of groups' score attribute from a bet
  // // @param       :: betId (required): the bet concerned
  // //                 cb (required): the function called when it's done or an
  // //                 error occured
  // computeGroupsFromBet: function (betId, cb) {
  //   // Check params
  //   checkParams([
  //     {
  //       value: betId,
